...
namespace Bones
{
    ...
    public static class Bones_GetHediffDefFromDamage_Patch
    {
        ...
        {
            var list = new List<HediffDef> { HediffDef.Named("SZ_Stable_Fracture"), HediffDef.Named("SZ_Compound_Fracture"), HediffDef.Named("SZ_Transverse_Fracture"), HediffDef.Named("SZ_Oblique_Fracture"), HediffDef.Named("SZ_Comminuted_Fracture") };
