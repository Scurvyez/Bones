...
namespace Bones
{
    public class ThoughtWorker_MissingArmBone : ThoughtWorker
    {
        protected override ThoughtState CurrentStateInternal(Pawn pawn)
        {
            IEnumerable<BodyPartRecord> partsWithTag = pawn.RaceProps.body.GetPartsWithTag(Bones_BodyPartTagDefOf.SZ_ArmBone_Tag);
